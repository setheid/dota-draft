...
heroes.list = [
  ...
  },
  {
    ...
    hero_class: 'agility',
    weak_against: ['riki', 'zuus', 'lion', 'meepo', 'visage', 'lone_druid', 'puck'],
    synergies: []
  },
  {
    name: 'nevermore',
    ...
    hero_class: 'agility',
    weak_against: ['lina', 'omniknight', 'riki', 'templar_assassin', 'treant', 'enchantress', 'chen', 'furion', 'sand_king', 'bristleback', 'ogre_magi'],
    synergies: []
  },
  {
    name: 'morphling',
    ...
    hero_class: 'agility',
    weak_against: ['lion', 'ancient_apparition', 'shadow_shaman', 'jakiro', 'bristleback', 'pugna', 'dazzle'],
    synergies: ['omniknight']
  },
  {
    name: 'phantom_lancer',
    id: 12,
    ...
    hero_class: 'agility',
    weak_against: ['sven', 'storm_spirit', 'centaur', 'slardar', 'ancient_apparition', 'ember_spirit', 'medusa', 'earthshaker', 'axe', 'dragon_knight'],
    synergies: []
  },
  {
    name: 'puck',
    ...
    localized_name: 'Puck',
    hero_class: 'intelligence',
    weak_against: ['silencer', 'centaur', 'faceless_void', 'templar_assassin', 'elder_titan', 'witch_doctor'],
    synergies: []
  },
  {
    name: 'pudge',
    ...
    hero_class: 'strength',
    weak_against: ['queenofpain', 'storm_spirit', 'bloodseeker', 'lycan', 'dazzle', 'rattletrap', 'furion', 'omniknight', 'obsidian_destroyer'],
    synergies: []
  },
  {
    name: 'razor',
    ...
    hero_class: 'agility',
    weak_against: ['vengefulspirit', 'sniper', 'dazzle', 'luna', 'enigma', 'crystal_maiden', 'phantom_lancer', ],
    synergies: []
  },
  {
    name: 'sand_king',
    ...
    hero_class: 'strength',
    weak_against: ['bounty_hunter', 'silencer', 'juggernaut', 'slardar', 'jakiro', 'tusk', 'lion', 'abaddon'],
    synergies: []
  },
  {
    name: 'storm_spirit',
    ...
    hero_class: 'intelligence',
    weak_against: ['spirit_breaker', 'antimage', 'templar_assassin', 'razor', 'silencer', 'skywrath_mage'],
    synergies: []
  },
  {
    name: 'sven',
    ...
    localized_name: 'Sven',
    hero_class: 'strength',
    weak_against: ['batrider', 'enigma', 'shadow_demon', 'antimage', 'dark_seer', 'ember_spirit', 'pugna'],
    synergies: []
  },
  {
    name: 'tiny',
    ...
    localized_name: 'Tiny',
    hero_class: 'strength',
    weak_against: ['silencer', 'queenofpain', 'puck', 'leshrac', 'beastmaster', 'dark_seer', 'storm_spirit'],
    synergies: []
  },
  {
    name: 'vengefulspirit',
